...
export default function index() {
  ...
  useEffect(() => {
    setTimeout(() => setShowLinks(true), 50);
  ...
  function A({ children, name, href }) {
    return (
      <a
        ...
        className={hoveredItem == name ? "active" : ""}
      >
        { hoveredItem == name ? (
  ...
  function Contact({ children, name, content }) {
    return (
      <div
        className={contactActive[name] ? "copied" : ""}
        onClick={() => {
          navigator.clipboard.writeText(content);
          setContactActive({ ...contactActive, [name]: true });
        }}
        onAnimationEnd={() => {
          setContactActive({ ...contactActive, [name]: false });
        }}
      >
        {children}{!contactActive[name] ? content : "copied"}
      </div>
    );
  }
  ...
  return (
    <>
      ...
      <div className={"contents" + (showLinks ? " blink2 show" : "")}>
        {viewMode.links ? (
          <div className="links">
            <A name="깃허브" href="https://github.com/lavi27">
            ...
            <A name="포트폴리오" href="https://lavi27.notion.site/33913aa09cd24ccc8c9d68c779a975f6">
            ...
            <A name="트위터" href="https://twitter.com/lavi_27_">
        ...
        {viewMode.contacts ? (
          <div className="contacts">
            <Contact name="discord" content="라비 lavi#2253">
